    ...
    <>
      ...
      <header className="w-full bg-white dark:bg-neutral-950 border-b border-neutral-200 dark:border-neutral-800">
        <div className=" flex items-center justify-between px-6 py-5 lg:px-8">
          {/* Left: SustainWear text */}
          <h1 className="text-2xl font-semibold tracking-tight text-[#5c6d3a]">
            Sustain<span className="text-[#768755]">Wear</span>
          </h1>
          ...
          <Link
            href="/"
            className="text-sm font-medium text-neutral-800 dark:text-neutral-100 hover:text-[#768755] transition-colors"
          >
            ← Back to Home
          </Link>
        </div>
      ...
      <main className="min-h-screen bg-white dark:bg-neutral-950 flex flex-col lg:flex-row items-center justify-center px-8 py-16 text-neutral-900 dark:text-neutral-100">
        ...
        <section className="flex-1 max-w-2xl mb-12 lg:mb-0 pr-8">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-lg leading-relaxed">
            ...
            Every item counts toward reducing textile waste.
          </p>
        </section>
